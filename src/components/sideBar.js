...
const SideBar = ({ userId, users }) => {
    ...
    return (
        <div className=" bg-blue-600 w-[44%] max-w-[230px] h-screen   text-gray-300 overflow-y-scroll">
            {(session && users) && (<>
                <div className="fixed bg-blue-600 pt-3">
                    {/* side bar header */}
                    <div className="uppercase text-sm md:text-[15px] items-center flex flex-col md:flex-row justify-between gap-2 pl-4">
                        <div className="flex break-all">
                            ...
                            <span>{userAcc[0].first_name}</span></div>
